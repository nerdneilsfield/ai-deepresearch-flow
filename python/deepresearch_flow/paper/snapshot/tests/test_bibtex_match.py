    ...
    try:
        ...
        conn.execute(
            ...
            (
                ...
                "arxiv",
                None,
                "BERT Pre-training of Deep Bidirectional Transformers for NLU",
                "2019",
                "10",
                "2019-10-01",
                "EMNLP",
        ...
        # Authors for paper 1
        conn.execute(
            "INSERT INTO author(author_id, value, paper_count) VALUES (1, 'Vaswani, Ashish', 1)"
        )
        conn.execute(
            "INSERT INTO author(author_id, value, paper_count) VALUES (2, 'Shazeer, Noam', 1)"
        )
        ...
        # Authors for paper 2
        conn.execute(
            "INSERT INTO author(author_id, value, paper_count) VALUES (3, 'Devlin, Jacob', 1)"
        )
