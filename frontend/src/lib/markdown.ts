...
import { resolveMarkdownItPlugin } from './module-interop'
...
md.use(resolveMarkdownItPlugin(markdownItFootnote))
md.use(resolveMarkdownItPlugin(markdownItKatexModule), { throwOnError: false, strict: false })
md.enable('table')
